...
public class BusinessService(HttpClient httpClient, IOptions<ApiSettings> options) : IBusinessService
{
    private readonly string BaseUri = options.Value.ApiUrl.TrimEnd('/') + "/api/v1/business";
