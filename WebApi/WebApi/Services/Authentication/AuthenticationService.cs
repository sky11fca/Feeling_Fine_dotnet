...
public class AuthenticationService(HttpClient client, IOptions<ApiSettings> options) : IAuthenticationService
{

    private readonly string BaseUrl = options.Value.ApiUrl.TrimEnd('/') + "/api/Authentication/";
